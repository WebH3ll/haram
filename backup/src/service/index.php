            ...
            <div class="resume-section-content">
                ...
                <div>
                    ...
                    <div class="input-group my-3">
                        <input type="text" class="form-control" placeholder="IP Address" aria-label="ip" aria-describedby="basic-addon1" id="ipAddress">
                ...
                <div>
                    ...
                    <div class="input-group my-3">
                        <input type="text" class="form-control" placeholder="URL Address" aria-label="url" aria-describedby="basic-addon1" id="urlAddress">
