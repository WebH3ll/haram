...
<body id="page-top">
                ...
                <div class="modal-dialog  modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- input -->
                            <p class="delete-modal-content">Are you sure you want to delete <br> your account?</p>

                            <div class="input-group mb-3">
                                <span class="input-group-text" id="inputGroup-sizing-default">&nbsp;*&nbsp;</span>
                                <input type="password" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1" name="upass" id="inputPassword">
                            </div>
                        </div>
    ...
    <script>
        function checkPassword() {
            location.href = "deleteProc.php?pwd=" + document.getElementById('inputPassword').value;
        }
    </script>
