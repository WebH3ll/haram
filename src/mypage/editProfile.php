                ...
                <? } else { ?>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="input-group my-3">
                            <input type="text" class="form-control" placeholder="<?= $data['name'] ?>" aria-label="Username" aria-describedby="basic-addon1" id="username">
                        </div>
                        <hr>
                        <p class="profile-title">New User ID</p>
                        <div class="input-group my-3">
                            <input type="text" class="form-control" placeholder="<?= $data['uid'] ?>" aria-label="Userid" aria-describedby="basic-addon1" id="uid">
                        </div>

                        <hr>
                        <p class="profile-title">New Password</p>
                        <div class="input-group my-3">
                            <input type="password" class="form-control" aria-label="Password" aria-describedby="basic-addon1" id="newpass">
                        </div>

                        <button type="button" class="btn edit-btn mt-5" data-bs-toggle="modal" data-bs-target="#editModal">Edit Profile</button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- input -->
                            <p class="edit-modal-content">Current password</p>

                            <div class="input-group mb-3">
                                <span class="input-group-text" id="inputGroup-sizing-default">&nbsp;*&nbsp;</span>
                                <input type="password" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1" name="upass" id="upass">
                            </div>
                        </div>
